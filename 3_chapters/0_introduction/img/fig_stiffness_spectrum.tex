...
at (axis cs:30000000,0.1) {\scriptsize soft};
\node[right, align=left]
at (axis cs:300000000,0.1) {\scriptsize rigid};
\end{axis}
...
\draw[-{Stealth}, color=black] (axis cs:0.5,0.2) -- (axis cs:0.15,0.2);
\draw[-{Stealth}, color=black] (axis cs:0.55,0.2) -- (axis cs:0.9,0.2);
\end{axis}
\end{tikzpicture}%