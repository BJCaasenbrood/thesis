...
\newcommand{\sorotoki}{\textup{\textit{Sorotoki}} }
\newcommand{\matlab}{\textup{\textit{MATLAB}} }
...
\newcommand{\terminology}[2]{\refstepcounter{TermNum}#2 \vspace*{2.1mm}\begin{tcolorbox}[colback=black!2!white,colframe=black!20!white] {\em #1} \end{tcolorbox}\vspace*{2.1mm}}
...
% End of sub-appendices environment
\AtEndEnvironment{subappendices}{%
\counterwithout{figure}{section}
\counterwithout{table}{section}
}

\newcommand{\cmark}{\textcolor{Matlab3}{\ding{51}}}%
\newcommand{\xmark}{\textcolor{Matlab2}{\ding{55}}}%
