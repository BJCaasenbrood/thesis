...
%%%% MAIN MATTERS *************************************************************
\isstarredchapterfalse          % This state variable is used for creating the thumb index by indicating that the following chapter is numbered (i.e. not \chapter*{})
...
\include{3_chapters/1_chapter/chapter1}
