...
\label{ch:2-dynamics} 
	...
	\input{./text/2_chap/4_projection/text}
	%\input{./text/2_chap/5_porthamiltonian/text}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\clearpage
%\chapter{Control of Soft Robots}
	%\input{./text/3_chap/1_underact/text}
	%\input{./text/3_chap/2_dis_shp/text}
	%\input{./text/3_chap/3_part_fbk/text}
	%\input{./text/3_chap/3_ke_control/text}

%% APPENDICES %% 
%\startappendices
%\input{./text/appendix/1_mathematics/text}
