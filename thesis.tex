...
\newcommand{\maintitle}{Design, Modeling, and Control \\[0.35em] Strategies for Soft Robot\hl{ics}}
\newcommand{\subtitle}{}
...
\input{3_chapters/1_chapter/chapter}
\fi
% *************************************************************
%\cleardoublepage
\ifx\printParts\undefined
...
% PCC-modeling frame
\input{3_chapters/2_chapter/chapter}

% Cosserat-beam frame work
\input{3_chapters/3_chapter/chapter}
\fi
% *************************************************************
