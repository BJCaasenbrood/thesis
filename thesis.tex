...
\newcommand{\defensedate}{woensdag ?? oktober 2023}
...
\label{chap:Sorotoki}
\blankfootnote{This chapter is based on: B.J. Caasenbrood, A.Y. Pogromsky, and H. Nijmijer. \texttt{Sorotoki}: \textit{a MATLAB toolkit for design, modeling, and control of soft robots} (\textit{in preparation for submission}). }
