...
\begin{enumerate}
  ...
  \item Soft robots, characterized by their numerous degrees of freedom, can be adequately managed by reduced-order controllers that target only a few principle modes of operation. %, focusing on the robots' inherent redundancy to cut through the complexity.
  \begin{flushright}
  \vspace{-5mm}
