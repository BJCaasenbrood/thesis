...
\objective{Development and analysis of new systematic tools balanced between the design, modeling, and control of soft continuum robots, whose goal is to strive for similar capabilities as rigid robotics and eventually biological systems.}
...
\contribution{A systematic study of spatial discretization in low-order energy-shaping controllers applied to high-order soft robotic models with a focus on closed-loop performance in shape and full-body grasping control.}{} 
\vspace{-5mm}
...
\thumbimageodd{\qrcode[height=1.0cm]{https://bit.ly/3zIvbHt}}{\texttt{Sorotoki}} \vspace{2mm}
