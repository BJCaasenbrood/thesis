...
%
\objective{Developement and analysis of new systematic tools balanced between the design, modeling, and control of soft continuum robots, whose goal is to pursue similar performance as rigid robotics and eventually biologal systems.}
%
...
\begin{itemize}
\setlength\itemsep{-.1em}
\item {Can we effectively explore the intrinsic morphological flexibilities of the soft robots, similar to biology, that are meaningful for modeling and control?}
\end{itemize}
%
...
\begin{itemize}
\setlength\itemsep{-.1em}
\item{To enable better designs and controllers for soft robotics community, how can we bridge the interdisciplinary aspects intrinsic to this field?}
\end{itemize}
%
