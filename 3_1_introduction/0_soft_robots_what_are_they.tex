...
\end{figure}
%
\terminology{\textbf{Soft materials} are defined as homogeneous materials with a Young's modulus, conventionally referred to as the modulus of elasticity, that is generally less than or equal to $10^9$ \si{\pascal}. In this context, the term "soft" or "softness" pertains to the set of mechanical properties that are commonly linked with low elasticity materials.}{}\
%
