...
\end{figure}
%
\terminology{\textbf{Soft materials} are homogeneous materials with a Young's modulus, often referred to as the elasticity modulus, that is typically less than or equal to $10^9$ \si{\pascal}. The term "softness" or "soft" refers to a collection of mechanical properties that are typically attributed to materials within this class.}{}\
%
